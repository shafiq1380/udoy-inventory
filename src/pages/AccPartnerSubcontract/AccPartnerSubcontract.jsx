...
function AccPartnerSubcontract() {
  ...
  return (
    <div className="page-content">
      <Breadcrumbs title="SETUP" breadcrumbItem="Partner / Partner Sub Contract" />
      ...
      <iframe title="external-iframe" src={`${REPORT_URL}/AccPartnerSubcontracts/Index?cCode=${cCode}&auth=${token}&`}
...
export default AccPartnerSubcontract;