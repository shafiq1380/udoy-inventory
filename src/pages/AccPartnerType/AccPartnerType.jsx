...
function AccPartnerType() {
  ...
  return (
    <div className="page-content">
      <Breadcrumbs title="SETUP" breadcrumbItem="Partner / Partner Type" />
      ...
      <iframe title="external-iframe" src={`${REPORT_URL}/AccPartnerTypes/Index?cCode=${cCode}&auth=${token}`}
