...
import { blcSlsDownloadVoucherReport, blcSlsShowPdfGenerator } from './CashFlowHOPDF';
...
const CashFlowHO = () => {
    ...
    // document.title = "Cash Flow (HO) | SMART Accounting System";
    ...
    return (
        <div className='page-content'>
            <Container fluid>
                <Breadcrumb title={'Report'} breadcrumbItem={'Cash Flow (HO)'} />
            </Container>
