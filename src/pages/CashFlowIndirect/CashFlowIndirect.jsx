...
import { blcSlsDownloadVoucherReport, blcSlsShowPdfGenerator } from './CashFlowIndirectPDF';
...
const CashFlowIndirect = () => {

    // document.title = "Cash Flow (Indirect) | SMART Accounting System";
    ...
    return (
        <div className='page-content'>
            <Container fluid>
                <Breadcrumb title={'Report'} breadcrumbItem={'Cash Flow (Indirect)'} />
            </Container>
