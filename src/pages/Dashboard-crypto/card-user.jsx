...
const CardUser = () => {
  ...
  const { userName, userPhoto, userID, } = useSelector(state => state.Login.userInformation)
        ...
        <Card>
          <CardBody>
            ...
            <div>
              ...
              <div>
                <h5>{userName}</h5>
                <p className="text-muted mb-1">{userName?.toLowerCase()}@abc.com</p>
                <p className="text-muted mb-0">Id no: {userID}4</p>
              </div>
            </div>
          </CardBody>
