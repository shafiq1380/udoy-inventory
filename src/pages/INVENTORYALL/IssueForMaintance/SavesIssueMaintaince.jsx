...
const SavedIssueMaintance = ({ activeTab }) => {
        ...
        <div className="table-responsive py-4">
            {
                transactionData?.length > 0 ?
                                ...
                                transactionData?.map((item) => (
                                    <tr className="p-2" key={item?.invTransactionHdr?.id}>
                                        ...
                                        <td className="col-5 text-center px-0">
                                            ...
                                            <Link
                                                to={`/issue-for-maintanance/${item?.invTransactionHdr.id}`}
                    ...
                    : transactionData?.length === 0 ?
                        <p className='text-center display-5 p-3'>No Data Found</p>
                        :
                        <CustomSpinner />
            }
...
export default SavedIssueMaintance