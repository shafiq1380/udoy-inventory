...
const MaterialAdjustment = () => {
    ...
    const [adjustment, setAdjustment] = useState({ value: 1, label: 'Adjust Receive', })
    ...
    return (
        <div className="mt-3 custom-fontSize">
                        ...
                        <Row style={{ zIndex: -10 }}>
                            <Col className="text-center" >
                                <button
                                    ...
                                    onClick={saveMaterialAdjustment}
                                >
                                    Save Material Adjustment
                                </button>
                            </Col>
                        </Row>
            ...
            <CmnSaveEditResponseModal
                ...
                modalTitle={" Saved Material Return"}
