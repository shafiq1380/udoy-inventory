...
const MaterialPurchaseRequisition = () => {
    ...
    // console.log('AllItem', allItemList.length)
    ...
    const handleAccountCodeChange = (event, index) => {
        ...
        const selectedAccount = productData?.find((item) => item.id === selectedTranId);
        ...
        if (selectedAccount) {
            ...
            updatedRows[index].itemName = selectedAccount.itemDesc;
    ...
    const savePurchaseRequisition = () => {
            ...
            data: {
                ...
                invTransactionDet: materialComponent.map((item) => {
                    ...
                    return {
                        ...
                        currentStock: item.stock ? item.stock : 0,
                    }
                })
            }
        }
        ...
        if (!data.data.invTransactionHdr.trnPartyID) {
            toast.error("Please select partner", toastOptions);
            return false;
        }
    ...
    return (
        <div className='custom-fontSize'>
            ...
            <Container fluid>
                ...
                <Card >
                    <CardBody>
                        <Row className='mb-3 '>
                            <Col sm="12" md="6" lg="3">
                                <Label for="transactionDate" size='md'>Transaction Date</Label>
                                <InputGroup>
                                    <Flatpickr
                            ...
                            <Col sm="12" md="6" lg="3">
                                <Label for="transactionDate" size='md'>Select Partner</Label>
                                <Select
                                    styles={customStyles}
                            ...
                            <Col sm="12" md="6" lg="4" >
                                <Label for="additionalRequirements" size='md'>Aditional Information</Label>
            ...
            <CmnSaveEditResponseModal
                ...
                modalTitle={"Saved Purchase Requisition"}
...
export default MaterialPurchaseRequisition