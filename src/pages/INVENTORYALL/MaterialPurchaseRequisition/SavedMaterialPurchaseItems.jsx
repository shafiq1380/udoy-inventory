...
import { TableFromSkeleton } from '../../../components/Common/Skeleton';


const SavedMaterialPurchaseItems = ({ activeTab }) => {
    ...
    const handleClickBtn = (value, id) => {
        ...
        if (value === 'print') {
            setModalText('Do you Want to To Print The Transaction')
                                ...
                                transactionData?.map((item) => (
                                    <tr className="p-2" key={item?.invTransactionHdr?.id}>
                                        ...
                                        <td className="col-5 text-center px-0">
                                            ...
                                            <Link
                                                to={`/transaction-edit/${item?.invTransactionHdr.id}`}
...
export default SavedMaterialPurchaseItems