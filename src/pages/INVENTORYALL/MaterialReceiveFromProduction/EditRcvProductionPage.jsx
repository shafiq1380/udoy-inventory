...
const EditRcvProductionPage = () => {
    ...
    return (
        <div className="page-content">
            <Container fluid>
                <Breadcrumb title="Transaction" breadcrumbItem="Edit Material Receive From Production" />
                <CardBody>
                    <Button
                        type="button"
                        color="success"
                            ...
                            <Row style={{ zIndex: -10 }}>
                                <Col className="text-center" >
                                    <button
                                        ...
                                        onClick={updateReceiveProduction}
                                    >
                                        Update Receive Production
                                    </button>
                                </Col>
                            </Row>
                        }
            ...
            <CmnSaveEditResponseModal
                ...
                modalTitle={"Updated Receive Production"}
...
export default EditRcvProductionPage