...
const SavedMaterialRequisitionAndIssue = ({ activeTab }) => {
    ...
    const handleClickBtn = (value, id) => {
        ...
        if (value === 'print') {
            setModalText('Do you Want  To Print This')
            setmodalTitle('Print Transaction')
        } else if (value === 'post') {
            setModalText('Do you Want to Post This Transaction')
            ...
            setModalText('Do you Want to Delete This')
                                ...
                                transactionData?.map((item) => (
                                    <tr className="p-2" key={item?.invTransactionHdr?.id}>
                                        ...
                                        <td className="col-5 text-center px-0">
                                            ...
                                            <Link
                                                to={`/transactionissue-edit/${item?.invTransactionHdr.id}`}
...
export default SavedMaterialRequisitionAndIssue