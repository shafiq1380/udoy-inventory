...
const EditSalesPage = () => {
    ...
    return (
        <div className="page-content">
            <Container fluid>
                <Breadcrumb title="Transaction" breadcrumbItem="Edit Material Sales" />
                <CardBody>
                    <Button
                        type="button"
                        color="success"
                            ...
                            <Row style={{ zIndex: -10 }}>
                                <Col className="text-center" >
                                    <button
                                        ...
                                        onClick={updateMaterialSales}
                                    >
                                        Update Material Sales
                                    </button>
                                </Col>
                            </Row>
                        }
            ...
            <CmnSaveEditResponseModal
                ...
                modalTitle={"Updated Material Sales"}
                responseId={responseId}
                error={error}
                nvurl={'/material-sales'}
            />
        </div>
    )
}
