...
const EditMaterialTransfer = () => {
    ...
    const [issueStoreId, setIssueStrID] = useState(null);
    ...
    const handleTranDate = (date) => {
        setTranHeaderData({ ...tranHeaderData, trnDate: date, updateDate: date })
    };
    ...
    const updateMaterailTransfer = () => {
        ...
        const data = {
            data: {
                invTransactionHdr: {
                    ...tranHeaderData, updateBy: userID, additionalInfo: addInfo, trnPartyID: tranHeaderData.trnPartyID, userCode: userID,
                    issueStoreId: issueStoreId?.value || tranHeaderData.issueStoreId, receiveStoreId: rcvStrID?.value || tranHeaderData.receiveStoreId
                },
                invTransactionDet: materialComponent.map((item) => {
                    ...
                    return {
                        ...
                        linQty: +item.linQty || 0,
                        linRate: +item.linRate || 0,
                        linAmount: 0,
                        invRate: 1,
                        invAmount: totalPrice || 0,
    ...
    // console.log(materialComponent)
    // console.log(issueStoreId)
    // console.log(allStoreList)

    return (
        <div className="page-content">
            <Container fluid>
                <Breadcrumb title="Transaction" breadcrumbItem="Edit Material Transfer" />
                <CardBody>
                    <Button
                        type="button"
                        color="success"
                    ...
                    <CardBody>
                        <Row className='mb-3 '>
                            ...
                            <Col sm="12" md="2" lg="2">
                                ...
                                <Select
                                    styles={customStyles}
                                    onChange={(event) => setIssueStrID(event)}
                                    ...
                                    value={issueStoreId || allStoreList.map(item => {
                                        if (item.storeID === tranHeaderData.issueStoreId) {
                                            return {
                                                label: item.storeCode,
                                                value: item.storeID
                                            };
                            ...
                            <Col sm="12" md="2" lg="2">
                                ...
                                <Select
                                    ...
                                    // autoFocus
                                    placeholder="Select Item Name"
                                    value={rcvStrID || allStoreList.map(item => {
                                        if (item.storeID === tranHeaderData.receiveStoreId) {
                                            return {
                                                label: item.storeCode,
                                                value: item.storeID
                                            };
                                                            ...
                                                            <tr key={index}>
                                                                ...
                                                                <td>
                                                                    <Row>
                                                                        <Col md={11}>
                                                                            ...
                                                                            />
                                                                            <p className='m-0'>
                                                                                {selectedTranValues?.[index]?.label || productData?.map(item => {
                                                                                    if (item.id === row.itemID) {
                                                                ...
                                                                <td>
                                                                    <input
                                                                        ...
                                                                        value={issueStoreId ? issueStoreId.label : allStoreList?.map(item => {
                                                                            if (item.storeID === tranHeaderData.issueStoreId) {
                            ...
                            <Row style={{ zIndex: -10 }}>
                                <Col className="text-center" >
                                    <button
                                        ...
                                        onClick={updateMaterailTransfer}
                                    >
            ...
            <CmnSaveEditResponseModal
                ...
                modalTitle={"Updated Material Transfer"}
