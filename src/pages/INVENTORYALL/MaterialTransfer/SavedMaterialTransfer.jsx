...
import MtPurAlertModals from './MtPurAlertModals';
import { AiFillInfoCircle } from 'react-icons/ai';


const SavedMaterialTransfer = ({ activeTab }) => {
    ...
    const handleClickBtn = (value, id) => {
        ...
        if (value === 'print') {
            setModalText('Are Your Sure To Print The Transaction')
            setmodalTitle('Print Transaction')
        } else if (value === 'post') {
            setModalText('Are you sure to Post The Transaction')
            ...
            setModalText('Are you sure to Delete The Transaction')
                                ...
                                transactionData?.map((item) => (
                                    <tr className="p-2" key={item?.invTransactionHdr?.id}>
                                        ...
                                        <td className="col-5 text-center px-0">
                                            ...
                                            <Link
                                                to={`/materialtransfer-edit/${item?.invTransactionHdr.id}`}
...
export default SavedMaterialTransfer