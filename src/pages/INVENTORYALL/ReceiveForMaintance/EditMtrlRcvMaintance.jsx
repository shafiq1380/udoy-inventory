...
const EditMtrlRcvMaintance = () => {
    ...
    return (
        <div className="page-content custom-fontSize">
            <Container fluid>
                <Breadcrumb title="Transaction" breadcrumbItem="Edit Material Receive For Maintance" />
                <CardBody>
                    <Button
                        type="button"
                        color="success"
                ...
                <Card>
                    <CardBody>
                        <Row className='mb-3 '>
                            <Col sm="12" md="6" lg="3">
                                <Label for="transactionDate" size='lg'>Issue Maintance Date</Label>
                                <InputGroup>
                                    <Flatpickr
                            ...
                            <Col sm="12" md="6" lg="3">
                                ...
                                <Select
                                    ...
                                    value={selectPartner ||
                                        allPartner.map((item) => {
                                            // console.log(tranHeaderData?.trnPartyID)
                            ...
                            <Row style={{ zIndex: -10 }}>
                                <Col className="text-center" >
                                    <button
                                        ...
                                        onClick={updateMtrlRcvMaintance}
                                    >
                                        Update Meterial Receive Maintance
                                    </button>
                                </Col>
                            </Row>
                        }
            ...
            <CmnSaveEditResponseModal
                ...
                modalTitle={"Updated Material Receive Maintance"}
                responseId={responseId}
                error={error}
                nvurl={'/rcv-for-maintanance'}
...
export default EditMtrlRcvMaintance