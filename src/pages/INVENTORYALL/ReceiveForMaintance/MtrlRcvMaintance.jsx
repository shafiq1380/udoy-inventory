    ...
    return (
        <div className="mt-3">
            ...
            <Container fluid>
                ...
                <Card>
                    <CardBody>
                        <Row className='mb-3 '>
                            <Col sm="12" md="6" lg="3">
                                <Label for="transactionDate" size='lg'>Maintance Date</Label>
                                <InputGroup>
                                    <Flatpickr
                                                    ...
                                                    <tr key={index}>
                                                        ...
                                                        <td>
                                                            <input
                                                                type="number"
                                                                name='quantity'
                                                                className="form-control tetxt-end"
                        ...
                        <Row style={{ zIndex: -10 }}>
                            <Col className="text-center" >
                                <button
                                    ...
                                    onClick={saveMtrlRcvMaintance}
                                >
                                    Save Material Receive Maintanance
                                </button>
                            </Col>
                        </Row>
            ...
            <CmnSaveEditResponseModal
                ...
                modalTitle={"Saved Material Maintance"}
...
export default MtrlRcvMaintance