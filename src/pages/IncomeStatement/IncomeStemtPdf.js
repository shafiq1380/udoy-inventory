...
export const incomeShowPdfGenerator = async (fstPrdStrDate, fstPrdEndDate, sndPrdStrDate, sndPrdEndDate, trdPrdStrDate, trdPrdEndDate) => {
    ...
    const baseUrl = `${REPORT_URL}/api/VoucherReport/GetIncomeStatementReport?cCode=${cCode}&auth=${token}&`
...
export const incomeDownloadVoucherReport = (
