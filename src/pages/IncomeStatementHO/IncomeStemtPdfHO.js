...
export const incomeShowPdfGenerator = async (fstPrdStrDate, fstPrdEndDate, sndPrdStrDate, sndPrdEndDate) => {
    ...
    const baseUrl = `${REPORT_URL}/api/VoucherReport/GetIncomeStatementHoReport?cCode=${cCode}&auth=${token}&`
