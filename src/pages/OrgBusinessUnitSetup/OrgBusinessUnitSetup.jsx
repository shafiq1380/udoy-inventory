...
function OrgBusinessUnitSetup() {
  ...
  return (
    <div className="page-content">
      <Breadcrumbs title="SETUP" breadcrumbItem="Organization / Business Unit" />
      ...
      <iframe title="external-iframe" src={`${REPORT_URL}/orgBusinessUnitSetups/Index?cCode=${cCode}&auth=${token}`}
...
export default OrgBusinessUnitSetup;