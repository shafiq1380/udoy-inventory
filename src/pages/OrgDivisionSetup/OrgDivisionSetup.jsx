...
function OrgDivisionSetup() {
  ...
  return (
    <div className="page-content">
      <Breadcrumbs title="SETUP" breadcrumbItem="Organization / Division Setup" />
      ...
      <iframe title="external-iframe" src={`${REPORT_URL}/orgDivisionSetups/Index?cCode=${cCode}&auth=${token}`}
...
export default OrgDivisionSetup;