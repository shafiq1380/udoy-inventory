...
function OrgEntitySetup() {
  ...
  return (
    <div className="page-content">
      <Breadcrumbs title="SETUP" breadcrumbItem="Organization / Legal Entity Setup" />
      ...
      <iframe title="external-iframe" src={`${REPORT_URL}/orgEntitySetups/Index?cCode=${cCode}&auth=${token}`}
