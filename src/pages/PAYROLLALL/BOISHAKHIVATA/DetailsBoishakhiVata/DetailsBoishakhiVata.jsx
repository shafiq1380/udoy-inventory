...
const DetailsBoishakhiVata = () => {
    ...
    const handlePostAllowance = useCallback(async () => {
        const data = {
            data: {
                id: state?.id,
                typeID: 3,          // typeID = 3 for Boishakhi Vata
                userCode: userID
            }
        };
    ...
    const handleEditAllowance = () => {
        navigate('/edit-boishakhi-vata', { state: state });
    }
        ...
        <div className="page-content">
            <Container fluid>
                ...
                <Card className="mt-2">
                    <CardBody>
                        <CardHeader>
                            <h3 className="text-center text-uppercase">Boishakhi Vata Details Screen</h3>
                        </CardHeader>
                    </CardBody>
                </Card>
...
export default DetailsBoishakhiVata;
