...
const EditBoishakhiVata = () => {
    ...
    useEffect(() => {
        ...
        const data = allowanceDataUpdateById.map((item) => {
            const basicSal = item.basicSal !== null ? item.basicSal : item.basic;
            const basic = basicSal;
            const percentBasic = (item.totAdition ? item.totAdition : item.basicSal * 0.2).toFixed(2);
    ...
    const editBoishakhiVata = allowanceData && allowanceData.length > 0 ? false : true;

    return (
        <div className="page-content">
            <Container fluid>
                <Breadcrumbs title="Transaction" breadcrumbItem="Boishakhi Vata Edit" />
                <Button
                    type="button"
                    color="success"
                ...
                <Card className="mt-2">
                    <CardBody>
                        <CardHeader>
                            <h3 className="text-center text-uppercase">Boishakhi Vata Edit Screen</h3>
                        </CardHeader>
                    </CardBody>
                </Card>

                {
                    editBoishakhiVata ? <div className="text-center"><CustomSpinner /></div>
                        :
                        <>
                            <Card className="mt-3">
                                <CardBody>
...
export default EditBoishakhiVata;
