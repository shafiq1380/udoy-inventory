...
const CreateFestivalBonus = () => {
    ...
    useEffect(() => {
        dispatch(fetchAllowanceDataForInsertByTypeRequest(2));
    }, [dispatch]);
    ...
    const createFestival = allowanceData && allowanceData.length > 0 ? false : true;


    return (
        <div className='page-content'>
            <Container fluid>
                <Breadcrumbs title="Transaction" breadcrumbItem="Create Festival Bonus" />
                <Button
                    type="button"
                    color="success"
                ...
                <Card className='mt-2'>
                    <CardBody>
                        <CardHeader>
                            <h3 className="text-center text-uppercase">Festival Bonus Screen</h3>
                        </CardHeader>
                    </CardBody>
                </Card>

                {
                    createFestival ? <div className="text-center"><CustomSpinner /></div>
                        :
                        <>
                            <Card className='mt-3'>
                                <CardBody>
...
export default CreateFestivalBonus;
