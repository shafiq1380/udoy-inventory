...
const EditFestivalBonus = () => {
    ...
    useEffect(() => {
        const data = allowanceDataUpdateById && allowanceDataUpdateById.map((item) => {
            ...
            return {
                ...
                basicSal,
                newBasic,
                revStamp: item.newBasic || item.basic > 0 ? 10 : item.revStamp,
    ...
    const editFestival = allowanceData && allowanceData.length > 0 ? false : true;

    return (
        <div className="page-content">
            <Container fluid>
                <Breadcrumbs title="Transaction" breadcrumbItem="Festival Bonus Edit" />
                <Button
                    type="button"
                    color="success"
                ...
                <Card className="mt-2">
                    <CardBody>
                        <CardHeader>
                            <h3 className="text-center text-uppercase">Festival Bonus Edit Screen</h3>
                        </CardHeader>
                    </CardBody>
                </Card>

                {
                    editFestival ? <div className="text-center"><CustomSpinner /></div>
                        :
                        <>
                            <Card className="mt-3">
                                <CardBody>
...
export default EditFestivalBonus;
