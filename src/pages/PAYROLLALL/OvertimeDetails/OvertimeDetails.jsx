...
import CmdTableTD from './CmdTableTD';
...
const OvertimeDetails = () => {
    ...
    const handleRemoveAllowance = useCallback(async () => {
        const data = {
            data: {
                id: state?.id,
                typeID: 1,          // typeID = 1 for Overtime Allowance
                userCode: userID
            }
        };
    ...
    return (
        <div className="page-content">
            <Container fluid>
                <Breadcrumbs title="Transaction" breadcrumbItem="Over Time Details" />
                <Button
                    type="button"
                    color="success"
                ...
                <Card className="mt-2">
                    <CardBody>
                        <CardHeader>
                            <h3 className="text-center text-uppercase">Overtime Details Screen</h3>
                        </CardHeader>
                    </CardBody>
                </Card>
                                    ...
                                    <tbody>
                                        {allowanceDetailsById.map((item, index) => (
                                            <tr key={index}>
                                                ...
                                                {/* <CmdTableTD item={item} index={index} /> */}
