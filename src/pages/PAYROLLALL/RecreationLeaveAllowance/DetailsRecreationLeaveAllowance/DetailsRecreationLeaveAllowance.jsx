...
const DetailsRecreationLeaveAllowance = () => {
    ...
    const handlePostAllowance = useCallback(async () => {
        const data = {
            data: {
                id: state?.id,
                typeID: 4,          // typeID = 4 for Recreation Leave
                userCode: userID
            }
        };
    ...
    const handleEditAllowance = () => {
        navigate('/edit-recreation-leave', { state: state });
    };
    ...
    return (
        <div className="page-content">
            <Container fluid>
                <Breadcrumbs title="Transaction" breadcrumbItem="Recreation Leave Allowance Details" />
                <Button
                    type="button"
                    color="success"
                ...
                <Card className="mt-2">
                    <CardBody>
                        <CardHeader>
                            <h3 className="text-center text-uppercase">Recreation Leave Allowance Details Screen</h3>
                        </CardHeader>
                    </CardBody>
                </Card>
...
export default DetailsRecreationLeaveAllowance;
