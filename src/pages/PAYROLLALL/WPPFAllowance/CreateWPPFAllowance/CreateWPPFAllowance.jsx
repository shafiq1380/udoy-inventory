...
const CreateWPPFAllowance = () => {
    ...
    useEffect(() => {
        dispatch(fetchAllowanceDataForInsertByTypeRequest(5)); // 5 is the allowanceTypeID for WPPF
    }, [dispatch]);
    ...
    const handleCreateAllowance = useCallback(async () => {
        ...
        const data = {
            data: {
                allowanceTypeID: 5, // 5 is the allowanceTypeID for WPPF
                allowanceID: 0,
    ...
    const createWPPFAllowance = allowanceData && allowanceData.length > 0 ? false : true;

    return (
        <div className='page-content'>
            <Container fluid>
                <Breadcrumbs title="Transaction" breadcrumbItem="Create WPPF Allowance" />
                <Button
                    type="button"
                    color="success"
                ...
                <Card className='mt-2'>
                    <CardBody>
                        <CardHeader>
                            <h3 className="text-center text-uppercase">WPPF Allowance Screen</h3>
                        </CardHeader>
                    </CardBody>
                </Card>

                {
                    createWPPFAllowance ? <div className="text-center"><CustomSpinner /></div>
                        :
                        <>
                            <Card className='mt-3'>
                                <CardBody>
...
export default CreateWPPFAllowance;
