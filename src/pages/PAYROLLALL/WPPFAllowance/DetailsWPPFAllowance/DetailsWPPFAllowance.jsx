...
const DetailsWPPFAllowance = () => {
    ...
    const handlePostAllowance = useCallback(async () => {
        const data = {
            data: {
                id: state?.id,
                typeID: 5,          // typeID = 5 for WPPF Allowance
                userCode: userID
            }
        };
    ...
    const handleEditAllowance = () => {
        navigate('/edit-wppf-allowance', { state: state });
    };
    ...
    return (
        <div className="page-content">
            <Container fluid>
                <Breadcrumbs title="Transaction" breadcrumbItem="WPPF Allowance Details" />
                <Button
                    type="button"
                    color="success"
                ...
                <Card className="mt-2">
                    <CardBody>
                        <CardHeader>
                            <h3 className="text-center text-uppercase">WPPF Allowance Details Screen</h3>
                        </CardHeader>
                    </CardBody>
                </Card>
...
export default DetailsWPPFAllowance;
