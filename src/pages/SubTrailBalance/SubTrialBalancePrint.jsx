...
import { subTrialDownloadVoucherReport, subTrialShowPdfGenerator } from './trialBalancePdfGenerator';
import { authorization } from '../../components/Common/Authorization';
import { useSelector } from 'react-redux';

const SubTrialBalancePrint = () => {
    ...
    const generatePdf = () => {
        setLoading(!loading)
        const pefLink = subTrialShowPdfGenerator(
            transactionFrom,
            transactionTo,
            accountType,
        );
    ...
    return (
        <div className='page-content'>
            <Container fluid>
                <Breadcrumb title={'Report'} breadcrumbItem={'Sub Trial Balance Print'} />
...
export default SubTrialBalancePrint