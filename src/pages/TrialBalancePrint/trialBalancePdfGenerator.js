...
export const trialShowPdfGenerator = async (
    transactionFrom,
    transactionTo,
    accountType,
    reportType
    ...
    const response = await axios.get(
        `${baseUrl}downloadtype=pdf&UserID=${userID}&ReportType=${rpType}&AccountGroup=${acctype}&FromDate=${fromDate}&ToDate=${toDate}`, {
        responseType: 'blob',
    })
        .then((response) => {
...
export const trialDownloadVoucherReport = (
    transactionFrom,
    transactionTo,
    accountType,
    reportType,
    ...
    window.location.href = `${baseUrl}downloadtype=${type}&UserID=${userID}&ReportType=${rpType}&AccountGroup=${acctype}&FromDate=${fromDate}&ToDate=${toDate}`
