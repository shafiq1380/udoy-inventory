...
const UnpostForm = ({ voucherRef, setVoucherRef,
    voucherDate, setVoucherDate, voucherAmount,
    setVoucherAmount, reason, setReason, unpostVoucher
}) => {
                    ...
                    <Row>
                        ...
                        <Col sm={12} md={6} lg={9}>
                            <input
                                ...
                                id="reason"
                                name="reason"
                                placeholder='Why do you want to unpost this voucher?'
                                value={reason}
