...
function UsrNodeSetup() {
  ...
  return (
    <div className="page-content">
      <Breadcrumbs title="SETUP" breadcrumbItem="User / User Node Setup" />
      ...
      <iframe title="external-iframe" src={`${REPORT_URL}/UsrNodeSetups/Index?cCode=${cCode}&auth=${token}`}
