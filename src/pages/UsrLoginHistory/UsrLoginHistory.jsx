...
function UsrLoginHistory() {
    ...
    return (
        <div className="page-content">
            <Breadcrumbs title="User History" breadcrumbItem="User / User History" />
            ...
            <iframe title="external-iframe" src={`${REPORT_URL}/UsrLoginHistories/Index?cCode=${cCode}&auth=${token}&`}
...
export default UsrLoginHistory;