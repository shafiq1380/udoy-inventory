...
function VoucherPermission() {
  ...
  return (
    <div className="page-content">
      <Breadcrumbs title="SETUP" breadcrumbItem="Voucher / Voucher Permission" />
      ...
      <iframe title="external-iframe" src={`${REPORT_URL}/UsrLoginInformations/Index?cCode=${cCode}&auth=${token}`}
