...
function VoucherTypeSetup() {
  ...
  return (
    <div className="page-content">
      <Breadcrumbs title="Voucher" breadcrumbItem="Voucher / Voucher Type" />
      ...
      <iframe title="external-iframe" src={`${REPORT_URL}/AccVoucherTypeSetups/Index?cCode=${cCode}&auth=${token}`}
...
export default VoucherTypeSetup;